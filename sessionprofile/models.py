...
# only use this model if we store the information in the database
if issubclass(backend, DatabaseBackend):
    ...
    class SessionProfile(models.Model):
        ...
        session = models.ForeignKey('sessions.Session', unique=True)
